...
value=1f
m=1}
C {code.sym} 480 -450 0 0 {name=NETLIST only_toplevel=false value="
.control
...
C {code.sym} 350 -450 0 0 {name=MODELS_GF only_toplevel=true value="
...
"}
C {vsource.sym} -570 -430 0 0 {name=VCLK value="PULSE(0 3.3 0 1n 1n 250n 500n)" savecurrent=false}
...
C {lab_pin.sym} -280 220 0 0 {name=p3 sig_type=std_logic lab=VDAC}
C {vsource.sym} -650 -430 0 0 {name=VIN value=1.65 savecurrent=false}
C {gnd.sym} -650 -400 0 0 {name=l30 lab=0}
C {vdd.sym} -650 -460 0 0 {name=l31 lab=VIN}
C {vdd.sym} -280 260 3 0 {name=l32 lab=VIN}
...
C {COMPARADOR/comparator_3v3_VSS.sym} -180 380 0 0 {name=x3}
C {gnd.sym} -200 270 0 0 {name=l26 lab=0}
