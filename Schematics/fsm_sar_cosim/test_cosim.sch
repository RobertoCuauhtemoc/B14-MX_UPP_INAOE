...
C {vsource.sym} 510 -460 1 0 {name=VCMP value=3.3 savecurrent=false}
...
value=1f
m=1}
C {code_shown.sym} 1310 -580 0 0 {name=s1 only_toplevel=false value="
.control
...
.endc
"}
C {/foss/designs/DACGF/DAC8BR2R_3v3.sym} 1250 -360 0 0 {name=x1}
